...
| 2026-08-02 | S07 | COMPLETE | shared 256 MiB byte-bounded LRU cache; early checksum hit; Session/cache identity accounting; deferred product store; runtime 2K/4K selector; viewport/AppSession regressions; planning files | Release app + viewport + AppSession targets PASS; related CTest 2/2 PASS (1.48 s); actual 2K shared cache/Coverage stress PASS; Hit/Miss/Eviction/Oversize/Clear PASS; `git diff --check` and scope audit PASS; repair 0/2 | pending isolated commit | Gate B: full Release/full CTest, default 2K plus one explicit 4K run |
